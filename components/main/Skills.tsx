...
const Skills = () => {
  return (
    <section
      className="flex flex-col justify-center gap-3 h-full items-center relative overflow-hidden py-20"
      id="skills"
    ...
    >
     ...
     <h2 className="text-white">Backend</h2>
        ...
        <h2 className="text-white">FullStack</h2>
     ...
     <h2 className="text-white">Other Skills</h2>
